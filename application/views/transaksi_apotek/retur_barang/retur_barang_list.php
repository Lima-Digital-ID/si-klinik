                ...
                <div class="box box-info box-solid">
                    ...
                    <div class="box-body">
                        <div class="row" style="margin-bottom: 10px">
                            <div class="col-md-4">
                                <?php echo anchor(site_url('transaksi_apotek/create_retur'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-success btn-sm"'); ?>
                            </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h4 id="totalretur" align="right"></h4>
    </div>
...
<script type="text/javascript">
    ...
    function cekDetail(id){
        ...
        $.ajax({
            type: "GET",
            url: "<?=base_url('transaksi_apotek/get_detail_retur/')?>"+id, //json get site
            dataType : 'json',
            success: function(response){
                ...
                for(i = 0; i < arrData.length; i++){
                    var table=    '<tr><td><div class="text-center">'+arrData[i]['kode_barang']+'</div></td>'+
                        ...
                        '<td><div class="text-left">'+arrData[i]['diskon']+'</div></td>'+
                        '<td><div class="text-left">'+arrData[i]['nama_gudang']+'</div></td>'+
                        '<td><div class="text-left">'+arrData[i]['lokasi']+'</div></td></tr>';
                    $('#detailObat').append(table);
                    var harga=arrData[i]['harga']-arrData[i]['diskon'];
                    jumlah=arrData[i]['jumlah']*harga;
                }
                $('#totalretur').html('Total Retur : '+jumlah);
            }
        });
