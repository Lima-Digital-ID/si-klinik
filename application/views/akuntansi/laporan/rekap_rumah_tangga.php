    ...
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-info box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">BUKU KAS PENGELUARAN REKENING RUMAH TANGGA</h3>
                    </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                foreach ($data=$this->Akuntansi_model->rekapRT($date) as $key => $value) {
                    $a=$key+1;
                ?>
                <tr>
                    <td><?=$a?></td>
                    ...
                    <?php
                    if($value->tipe == 'DEBIT' && $value->id_akun == 36){
                        $saldo+=$value->jumlah;
                        $debit+=$value->jumlah;
                    ?>
