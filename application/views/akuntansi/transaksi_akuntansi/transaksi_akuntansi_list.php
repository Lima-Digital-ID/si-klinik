            ...
            <div class="col-xs-12">
                <div class="box box-info box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">JURNAL AKUNTANSI</h3>
                    </div>
                    ...
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            ...
                            <div class="row">
                                <div class="col-sm-3">    
                                <?php echo anchor(site_url('akuntansi/transaksi_akuntansi/create'), '<i class="fa fa-plus" aria-hidden="true"></i> Tambah Jurnal Manual', 'class="btn btn-info btn-sm"'); ?>
                                <!-- <a href="<?=site_url('akuntansi/transaksi_akuntansi/tutup_buku')?>" class="btn btn-success btn-sm" <?=($tgl_tutup_buku < $bulan ? 'disabled' : '')?>>Tutup Buku </a> -->
                                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        ?>
                            ...
                            <td><div class=""><?=formatDate($value->tanggal)?></div></td>
                        ...
                        ?>
                            ...
                            <th><a href="<?=base_url('akuntansi/transaksi_akuntansi/delete/')?><?=$v->id_trx_akun?>" class="btn btn-danger" title="hapus jurnal" onclick="javascript: return confirm('Apakah anda yakin akan menghapus ini?')"><i class="fa fa-trash" style="color:white"></i></a> <a href="<?=base_url('akuntansi/transaksi_akuntansi/rollback/')?><?=$v->id_trx_akun?>" class="btn btn-warning"><i class="fa fa-refresh" title="balik jurnal" style="color:white"></i></a></th>
                            </tr>
                        <?php
                                        }else{
                        ?>
                        ...
                        <tr>
                            <td><div class="text-center"></div></td>
                            <td><div class="text-left"><strong>(<?=$value->deskripsi?>)</strong></div></td>
                            <td><div class="text-left"></div></td>
                            <td><div class="text-left"></div></td>
                            <td><div class="text-left"></div></td>
                            <td></td>
