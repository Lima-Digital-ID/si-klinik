<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor(site_url('pegawai/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-info btn-sm"'); ?>
                    ...
                    columns: [
                        {
                            "data": "id_pegawai",
                            "orderable": false
                        },{"data": "nama_pegawai"},{"data": "no_hp"},{"data": "email"},{"data": "nama_jabatan"},{"data": "nama_klinik"},{"data": "tanggal_mulai_tugas"},
                        {
                            "data" : "action",
                            "orderable": false,
