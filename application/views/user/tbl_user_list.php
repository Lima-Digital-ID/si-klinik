<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor(site_url('user/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-info btn-sm"'); ?>
                    ...
                    columns: [
                        {
                            "data": "id_users",
                            "orderable": false
                        },{"data": "full_name"},{"data": "email"},{"data": "nama_level"},{"data": "is_aktif"},{"data": "dokter"},{"data": "klinik"},
                        {
                            "data" : "action",
                            "orderable": false,
