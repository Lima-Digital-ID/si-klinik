                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr><td></td><td><button type="submit" class="btn btn-success btn-sm">Simpan Perubahan</button></td></tr>
                        </table>
                    </form>
                    </div>
                </div>
                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                        <div style="padding-bottom: 10px;"'>
                            <?php echo anchor(site_url('kelolamenu/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-success btn-sm"'); ?>
