...
if($id_klinik != ''){
    if($rekap_laporan == 1){
?>
            ajax: {"url": "json_biaya_pemeriksaan/<?php echo $rekap_laporan.'_'.$filter_tanggal.'_'.$id_klinik;?>", "type": "POST"},
<?php
    } else if ($rekap_laporan == 2) {
?>
            ajax: {"url": "json_biaya_pemeriksaan/<?php echo $rekap_laporan.'_'.$filter_bulan.'_'.$id_klinik;?>", "type": "POST"},
<?php
    } else if ($rekap_laporan == 3) {
?>
            ajax: {"url": "json_biaya_pemeriksaan/<?php echo $rekap_laporan.'_'.$filter_tahun.'_'.$id_klinik;?>", "type": "POST"},
<?php
    }
}
?>
