            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                		...
                		<?php echo anchor(site_url('laporankeuangan/excelTindakan/'.$_GET['dari'].'_'.$_GET['sampai']), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Ms Excel', 'class="btn btn-success btn-sm"'); ?>
