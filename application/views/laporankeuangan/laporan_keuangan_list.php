            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">LAPORAN TRANSAKSI KEUANGAN</h3>
                    </div>
...
if($id_klinik != ''){
    if($rekap_laporan == 1){
?>
            ajax: {"url": "laporankeuangan/json/<?php echo $rekap_laporan.'_'.$filter_tanggal.'_'.$id_klinik;?>", "type": "POST"},
<?php
    } else if ($rekap_laporan == 2) {
?>
...
?>
            ajax: {"url": "laporankeuangan/json/<?php echo $rekap_laporan.'_'.$filter_tahun.'_'.$id_klinik;?>", "type": "POST"},
<?php
    }
}
?>
