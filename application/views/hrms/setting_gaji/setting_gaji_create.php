        ...
        <div class="box box-info box-solid">
            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-10">
                    <div class="">
                      <div class="checkbox-inline">
                        <label><input type="checkbox" name="check_uk" id="check_uk" onclick="CheckUk(this)"> Uang Kehadiran</label>
                      </div>
                      <div class="checkbox-inline">
                        <label><input type="checkbox" name="check_um" id="check_uk" onclick="CheckUm(this)"> Uang Makan</label>
                      </div>
                      <div class="checkbox-inline">
                        <label><input type="checkbox" name="check_ut" id="check_uk" onclick="CheckUt(this)"> Uang Transport</label>
                      </div>
                    </div>
                  </div>
                  </div>
                  <div class="col-sm-12" id="div_uk" hidden>
                  <br>
                    <div class="col-sm-2">
                      <label>
                  ...
                  <div class="col-sm-12" id="div_um" hidden>
                  <br>
                    <div class="col-sm-2">
                      <label>
                  ...
                  <div class="col-sm-12" id="div_ut" hidden>
                  <br>
                    <div class="col-sm-2">
                      <label>
