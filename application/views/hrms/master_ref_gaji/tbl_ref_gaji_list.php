<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor(site_url('hrms/ref_gaji/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-info btn-sm"'); ?>
                    ...
                    columns: [
                        {
                            "data": "id_ref_gaji",
                            "orderable": false
                        },{"data": "nama_jabatan"},{"data": "gaji_pokok"},{"data": "uang_kehadiran"},{"data": "uang_makan"},{"data": "uang_transport"},{"data": "uang_lembur"},
                        {
                            "data" : "action",
                            "orderable": false,
