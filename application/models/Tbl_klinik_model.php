...
class Tbl_klinik_model extends CI_Model
{

    public $table = 'tbl_klinik';
    public $id = 'id_klinik';
    public $order = 'DESC';
    ...
    // datatables
    function json() {
        $this->datatables->select('id_klinik, nama, alamat');
        $this->datatables->from('tbl_klinik');
        $this->datatables->add_column('action', anchor(site_url('klinik/update/$1'),'<i class="fa fa-pencil-square-o" aria-hidden="true"></i>', array('class' => 'btn btn-success btn-sm'))." 
                ".anchor(site_url('klinik/delete/$1'),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_klinik');
