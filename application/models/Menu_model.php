...
class Menu_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action', anchor(site_url('kelolamenu/read/$1'),'<i class="fa fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-info btn-sm'))." 
            ".anchor(site_url('kelolamenu/update/$1'),'<i class="fa fa-pencil-square-o" aria-hidden="true"></i>', array('class' => 'btn btn-success btn-sm'))." 
